...
usage() {
    echo "$(date) Usage: $0 -PathOutputReference <dir> -speciesNames <species1> [<species2>] -condaEnv <name> [-threads <num> -PathGenFastaFile <path> [<path>] -PathGtfFile <path> [<path>]]
